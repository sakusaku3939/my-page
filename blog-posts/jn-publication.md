...
LLMを用いる方法であれば一連の処理を完全自動化できる可能性がある。しかし、口頭/ポスター/デモといった発表形式はタイトルに明示されていない場合も多く、実際には本人への確認が必要になるケースもある。また、数年単位で運用することを考えると、LLMの仕様変更による影響も無視できない。将来的に後輩が引き継ぐ可能性を考慮し、運用が分かりやすい方法を選んだ。[^1]
