...
# 今の課題と所感
一方で、SSH上で作業するといった用途ではまだまだ不便な点が多い。特に、CursorやVSCodeはMicrosoft公式のRemote SSHプラグインに対応しており、リモートサーバー上での開発を快適に行えるが、Kiroはまだ対応していない。
今後、Remote SSHプラグインに対応してくれると嬉しいなと思う。
